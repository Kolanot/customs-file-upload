...
class FileUploadNotificationServiceSpec extends UnitSpec with MockitoSugar {
  ...
  trait SetUp {
    ...
    private[FileUploadNotificationServiceSpec] val service = new FileUploadNotificationService(mockFileUploadMetadataRepo, mockNotificationConnector, mockCdsLogger)
    ...
    private[FileUploadNotificationServiceSpec] implicit val toXml: CallbackToXmlNotification[FileTransmissionNotification] =
      new uk.gov.hmrc.customs.file.upload.services.FileTransmissionCallbackToXmlNotification()
  }
