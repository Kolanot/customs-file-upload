...
class UpscanInitiateConnectorSpec extends UnitSpec with MockitoSugar with BeforeAndAfterEach with Eventually {
  ...
  private val upscanInitiatePayload = UpscanInitiatePayload("https://callbackurl.com", 10000, "https://success-redirect.com", "https://error-redirect.com")
  ...
  private def awaitRequest = {
    await(connector.send(upscanInitiatePayload, VersionOne))
  }
