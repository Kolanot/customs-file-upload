...
trait ComponentTestSpec extends FeatureSpec
  ...
  override implicit lazy val app: Application = new GuiceApplicationBuilder()
    ...
    "microservice.services.upscan-initiate-v2.context" -> CustomsFileUploadExternalServicesConfig.UpscanInitiateContext,
    ...
    "microservice.services.upscan-initiate-v1.context" -> CustomsFileUploadExternalServicesConfig.UpscanInitiateContext,
